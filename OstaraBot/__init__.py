...
if ENV:
    ...
    from OstaraBot.config import Development as Config
    TOKEN = Config.TOKEN
...
telethn = TelegramClient("OstaraBot", API_ID, API_HASH)
...
from OstaraBot.modules.helper_funcs.handlers import (CustomCommandHandler,
