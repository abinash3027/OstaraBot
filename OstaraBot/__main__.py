...
from OstaraBot.modules.helper_funcs.misc import paginate_modules
...
I'm a modular group management bot and help admins manage their groups. Have a look at the following for an idea of some of the things I can help you with. 
...
OSTARA_IMG = "https://telegra.ph/file/3ab6fced3f87733bed1a3.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
OstaraBot doesn't require any donations as of now but \
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add OstaraBot to your group",
                     ...
                     [
                         ...
                         InlineKeyboardButton(
                             ...
                             url="https://t.me/OstaraBotSupport")
                     ],
                     [
                         InlineKeyboardButton(
                             text="🧾 Getting started guide",
                             url="https://t.me/OstaraBotSupport/67")
                     ],
                     [
                         InlineKeyboardButton(
                             text="🗄 Source code",
                             url="https://github.com/abinash3027/OstaraBot")
                     ]]))
    else:
