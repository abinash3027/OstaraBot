...
from OstaraBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("OstaraBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `OstaraBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
