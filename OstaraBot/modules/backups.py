...
from OstaraBot import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from OstaraBot.__main__ import DATA_IMPORT
from OstaraBot.modules.helper_funcs.chat_status import user_admin
from OstaraBot.modules.helper_funcs.alternate import typing_action

# from OstaraBot.modules.rules import get_rules
import OstaraBot.modules.sql.rules_sql as rulessql

# from OstaraBot.modules.sql import warns_sql as warnssql
import OstaraBot.modules.sql.blacklist_sql as blacklistsql
from OstaraBot.modules.sql import disable_sql as disabledsql

# from OstaraBot.modules.sql import cust_filters_sql as filtersql
# import OstaraBot.modules.sql.welcome_sql as welcsql
import OstaraBot.modules.sql.locks_sql as locksql
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @OstaraBotSupport"
            )
...
def export_data(update, context):
    ...
    f = open("OstaraBot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("OstaraBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `OstaraBot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("OstaraBot{}.backup".format(chat_id))  # Cleaning file
