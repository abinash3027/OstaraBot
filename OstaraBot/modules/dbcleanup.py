...
import OstaraBot.modules.sql.global_bans_sql as gban_sql
import OstaraBot.modules.sql.users_sql as user_sql
from OstaraBot import DEV_USERS, OWNER_ID, dispatcher
