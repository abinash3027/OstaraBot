...
import OstaraBot.modules.sql.welcome_sql as sql
from OstaraBot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
...
from OstaraBot.modules.helper_funcs.msg_types import get_welcome_type
