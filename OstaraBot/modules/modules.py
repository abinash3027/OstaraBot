...
from OstaraBot import dispatcher, telethn
from OstaraBot.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("OstaraBot.modules.", 1)[1]
