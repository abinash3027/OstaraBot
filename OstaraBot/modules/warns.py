...
import telegram
from OstaraBot import TIGERS, WOLVES, dispatcher
...
from OstaraBot.modules.helper_funcs.string_handling import split_quotes
from OstaraBot.modules.log_channel import loggable
from OstaraBot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # OstaraBot's sticker
        keyboard = None
